...
import torch
from utils.preproccessing import MineralPreprocessing  # Import pre-processing class
class MineralDataset(Dataset):
    ...
    def __getitem__(self, idx: int) -> torch.Tensor:
        ...
        Returns:
            Tuple[torch.Tensor, Tuple[int, int], str]: A tuple containing:
                - The processed image tensor.
                - A tuple of (x_coordinate, y_coordinate).
